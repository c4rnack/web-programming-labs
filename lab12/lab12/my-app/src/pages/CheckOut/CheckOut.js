...
import { postCart } from '../../API/api.js';
...
function CheckOut() {
  document.title = 'BookAHotel - check out';
        ...
        {({ errors, touched }) => (
          <Form>
            ...
            <div className='checkout__buttons'>
              <Link to="/cart">
                <button className='checkout__buttons-back' type="button">Go Back</button>
              </Link>
              <button className='checkout__buttons-continue' type="submit">Continue</button>
            </div>
          </Form>
        )}
      </Formik>
